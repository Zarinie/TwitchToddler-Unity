...
namespace Habrador_Computational_Geometry
{
    public static class _Delaunay
    {
        ...
        public static HashSet<Triangle2> FlippingEdges(HashSet<MyVector2> points, HalfEdgeData2 triangleData)
        {
            HashSet<Triangle2> triangles = DelaunayFlipEdges.GenerateTriangulation(points, triangleData);
